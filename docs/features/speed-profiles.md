...
- Default enabled: Walk, Bike, Drive. Slow Walk and Run are opt-in.
...
- Round-trips through export/import via `AppSettings.enabledSpeedProfileIds`; old exports without the field default to Walk/Bike/Drive.
